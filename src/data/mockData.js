...
export const channels = [
  {
    id: 1, name: 'Tech Insider', niche: 'Technology', status: 'Active',
    avatar: 'TI', subs: '1.2M', rtViews: '125K', ctr: '8.5%', revenue: '$4,200',
    views: '450K', watchTime: '85K hrs', retention: '42%',
    lastUpload: 'Today', uploadStatus: 'Fresh',
    trend: 'growing',
    subsTrend: { val: '+3.2%', dir: 'up' },
    viewsTrend: { val: '+12%', dir: 'up' },
    watchTrend: { val: '+8%', dir: 'up' },
    revTrend: { val: '+5%', dir: 'up' },
    lastVideoPerf: '125K views · 8.5% CTR · 42% ret.',
  },
  {
    id: 2, name: 'Gaming Pro', niche: 'Gaming', status: 'Active',
    avatar: 'GP', subs: '850K', rtViews: '98K', ctr: '6.2%', revenue: '$3,100',
    views: '320K', watchTime: '72K hrs', retention: '38%',
    lastUpload: '2 days ago', uploadStatus: 'Active',
    trend: 'growing',
    subsTrend: { val: '+1.2%', dir: 'up' },
    viewsTrend: { val: '+8%', dir: 'up' },
    watchTrend: { val: '+5%', dir: 'up' },
    revTrend: { val: '+12%', dir: 'up' },
    lastVideoPerf: '98K views · 6.2% CTR · 38% ret.',
  },
  {
    id: 3, name: 'Cooking Daily', niche: 'Lifestyle', status: 'Active',
    avatar: 'CD', subs: '450K', rtViews: '45K', ctr: '12.4%', revenue: '$1,800',
    views: '210K', watchTime: '41K hrs', retention: '55%',
    lastUpload: 'Today', uploadStatus: 'Fresh',
    trend: 'stable',
    subsTrend: { val: '+0.8%', dir: 'up' },
    viewsTrend: { val: '-2%', dir: 'down' },
    watchTrend: { val: '+1%', dir: 'up' },
    revTrend: { val: '+2%', dir: 'up' },
    lastVideoPerf: '45K views · 12.4% CTR · 55% ret.',
  },
  {
    id: 4, name: 'Finance Hub', niche: 'Business', status: 'Active',
    avatar: 'FH', subs: '320K', rtViews: '22K', ctr: '9.1%', revenue: '$5,200',
    views: '95K', watchTime: '28K hrs', retention: '48%',
    lastUpload: '5 days ago', uploadStatus: 'Needs Upload',
    trend: 'growing',
    subsTrend: { val: '+5.2%', dir: 'up' },
    viewsTrend: { val: '+15%', dir: 'up' },
    watchTrend: { val: '+10%', dir: 'up' },
    revTrend: { val: '+22%', dir: 'up' },
    lastVideoPerf: '22K views · 9.1% CTR · 48% ret.',
  },
  {
    id: 5, name: 'AI Future', niche: 'Technology', status: 'Active',
    avatar: 'AF', subs: '150K', rtViews: '85K', ctr: '10.5%', revenue: '$2,400',
    views: '180K', watchTime: '35K hrs', retention: '51%',
    lastUpload: '3 days ago', uploadStatus: 'Active',
    trend: 'growing',
    subsTrend: { val: '+18%', dir: 'up' },
    viewsTrend: { val: '+45%', dir: 'up' },
    watchTrend: { val: '+38%', dir: 'up' },
    revTrend: { val: '+18%', dir: 'up' },
    lastVideoPerf: '85K views · 10.5% CTR · 51% ret.',
  },
  {
    id: 6, name: 'Travel Vlogs', niche: 'Lifestyle', status: 'Declining',
    avatar: 'TV', subs: '680K', rtViews: '12K', ctr: '4.5%', revenue: '$900',
    views: '48K', watchTime: '9K hrs', retention: '29%',
    lastUpload: '21 days ago', uploadStatus: 'Inactive',
    trend: 'declining',
    subsTrend: { val: '-0.5%', dir: 'down' },
    viewsTrend: { val: '-45%', dir: 'down' },
    watchTrend: { val: '-38%', dir: 'down' },
    revTrend: { val: '-30%', dir: 'down' },
    lastVideoPerf: '12K views · 4.5% CTR · 29% ret.',
  },
];
